...
<a href="${f:url('finanziamenti?page=regoleIscrizione')}">Torna su</a>
<h3>Passo 2 - Chi altro è convolto nel progetto?</h3>

<p class="titoloPasso">Nessuno (a parte il contraente/beneficiario principale)</p>
...
<p class="titoloPasso">Solo i partner della mia regione o del mio paese</p>
...
<p class="titoloPasso">Partner di Stati non membri dell'UE</p>
